...
new #[Title('Live Quiz')] #[Layout('layouts.app')] class extends Component
{
    use Toast;
    ...
    public function onLiveStarted(array $data): void
    {
        if (($data['quiz_id'] ?? null) !== $this->quiz->id) {
            return;
        }
    ...
    public function onLeaderboardUpdated(array $data): void
    {
        if (($data['quiz_id'] ?? null) !== $this->quiz->id) {
            return;
        }
