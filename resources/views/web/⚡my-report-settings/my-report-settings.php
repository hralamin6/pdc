...
new #[Title('Daily Report Settings')] #[Layout('layouts.web')] class extends Component
{
    use Toast;
    ...
    public function saveCustomItem(): void
    {
        $this->validate([
    ...
    public function deleteCustomItem(int $itemId): void
    {
        $item = UserReportItem::where('user_id', auth()->id())->where('id', $itemId)->firstOrFail();
        $item->delete();
        $this->loadItems();
