...
return [
    ...
    'backup_failed_subject' => 'Backups von :application_name konnte nicht erstellt werden',
    'backup_failed_body' => 'Wichtig: Beim Backups von :application_name ist ein Fehler aufgetreten',

    'backup_successful_subject' => 'Erfolgreiches neues Backups von :application_name',
    'backup_successful_subject_title' => 'Erfolgreiches neues Backups!',
    'backup_successful_body' => 'Gute Nachrichten, ein neues Backups von :application_name wurde erfolgreich erstellt und in :disk_name gepeichert.',
    ...
    'unhealthy_backup_found_not_reachable' => 'Das Backups Ziel konnte nicht erreicht werden. :error',
    'unhealthy_backup_found_empty' => 'Es gibt für die Anwendung noch gar keine Backups.',
    'unhealthy_backup_found_old' => 'Das letzte Backups am :date ist zu lange her.',
    ...
    'disk' => 'Speicherort',
    'newest_backup_size' => 'Neuste Backups-Größe',
    'number_of_backups' => 'Anzahl Backups',
    'total_storage_used' => 'Gesamter genutzter Speicherplatz',
    'newest_backup_date' => 'Neustes Backups',
    'oldest_backup_date' => 'Ältestes Backups',
];
