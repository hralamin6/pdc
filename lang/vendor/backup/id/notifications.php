...
return [
    ...
    'backup_successful_subject' => 'Backups baru sukses dari :application_name',
    'backup_successful_subject_title' => 'Backups baru sukses!',
    ...
    'healthy_backup_found_subject' => 'Backups untuk :application_name pada disk :disk_name sehat',
    'healthy_backup_found_subject_title' => 'Backups untuk :application_name sehat',
    'healthy_backup_found_body' => 'Backups untuk :application_name dipertimbangkan sehat. Kerja bagus!',

    'unhealthy_backup_found_subject' => 'Penting: Backups untuk :application_name tidak sehat',
    'unhealthy_backup_found_subject_title' => 'Penting: Backups untuk :application_name tidak sehat. :problem',
    'unhealthy_backup_found_body' => 'Backups untuk :application_name pada disk :disk_name tidak sehat.',
    ...
    'unhealthy_backup_found_old' => 'Backups terakhir dibuat pada :date dimana dipertimbahkan sudah sangat lama.',
    'unhealthy_backup_found_unknown' => 'Maaf, sebuah alasan persisnya tidak dapat ditentukan.',
    'unhealthy_backup_found_full' => 'Backups menggunakan terlalu banyak kapasitas penyimpanan. Penggunaan terkini adalah :disk_usage dimana lebih besar dari batas yang diperbolehkan yaitu :disk_limit.',
